    ...
    <div className='bg-light d-flex gap-2 flex-row'>
      <div className='card-header'>
        <div className='card-img-top'>
          <Image
            src={data?.imagesURL?.[0]??"/face.jpeg"}
      ...
      <div className="d-block flex-column">
          ...
          <ul className=" list-unstyled">
            ...
            <li className="d-flex justify-content-between">
              ...
              <ul className='d-flex list-unstyled justify-content-around fw-light'>
                ...
                <li className="text-uppercase fw-light">&nbsp;{data?.dimension?.unit}</li>
              </ul>
            </li>
            <li className="d-flex justify-content-between">
        ...
        <div className='card-footer d-flex justify-content-between bg-light'>
          ...
          <span className="text-muted fw-light">{new Date(data?.createdAt).toLocaleDateString('en-GB')}</span>
        </div>
      </div>
    </div>
  );
