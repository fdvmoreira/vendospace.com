  ...
  return (
    <div className='card'>
      <div className='card-header d-flex justify-content-between'>
        <small className="text text-uppercase text-nowrap text-muted">ID:&nbsp;{_id}</small>
        <small className='text-muted'>Posted&nbsp;{new Date(createdAt).toLocaleDateString()}</small>
      </div>
      <div className='card-body'>
        <div className="d-flex gap-2">
          ...
          <div className="fw-light">
            ...
            <p className="bi bi-aspect-ratio d-flex justify-content-between">Dimensions:&nbsp;
              <span>                
            ...
            <p className='bi bi-geo-alt'>
              ...
              <span className="text-right"> {space?.location.latitude},{space?.location.longitude}</span>
            </p>          
          </div>                    
        </div>
      </div>
      <div className='card-footer'>
        ...
        :<Link href={'/login'} className="btn btn-outline-primary btn-sm">Authenticate to message the owner</Link>}
